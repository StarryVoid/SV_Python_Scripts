...
# (list)Extended DNS server for additional queries , Default is "['8.8.8.8','1.1.1.1','1.2.4.8']"
...
def main():
    try:
        ...
        if bool(Difference_Status) :
            ...
            subprocess.Popen(str(Auto_Reload_Nginx_Command),shell=True).returncode
    #
    except Exception as Error:
